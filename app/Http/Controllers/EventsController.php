...
class EventsController extends BaseController
{
    ...
    public function getEventsWithWorkshops() {
         $users = DB::table('events')->join('workshops', 'events.id', '=', 'workshops.event_id')->get();
        return $data;
    }
    ...
    public function getFutureEventsWithWorkshops($data) {
        $current_events = DB::table('workshops')->select( 'id','event_name' )
    ->where( DB::raw('now()'), '>=', DB::raw('start') )
    ->where( DB::raw('now()'), '<=', DB::raw('end') )->get();
